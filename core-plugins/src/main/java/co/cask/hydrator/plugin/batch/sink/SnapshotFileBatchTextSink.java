...
public class SnapshotFileBatchTextSink extends SnapshotFileBatchSink<String, NullWritable> {
  ...
  public void transform(StructuredRecord input,
    ...
    emitter.emit(new KeyValue<>(recordTransformer.transform(input, input.getSchema()),
                                NullWritable.get()));
  }
  ...
  public static class SnapshotFileBatchTextSinkConfig extends SnapshotFileSetBatchSinkConfig {
    @Description("The Delimiter used to combine the Structured Record fields")
    private String delimiter;

    public SnapshotFileBatchTextSinkConfig(String name, @Nullable String basePath, String delimiter) {
